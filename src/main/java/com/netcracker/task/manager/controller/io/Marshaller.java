...
public interface Marshaller {
    ...
    Journal read(String pathToBackup) throws IOException, TextMarshallerReadException, CreateFileException,
                                             PropertyReadException, BufferedReaderException, FileInputStreamException;
